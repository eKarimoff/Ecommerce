            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4" wire:model="stock">
                            <select class="form-control">
                            <option value="instock">Instock</option>
                            <option value="outofstock">Stock</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4" wire:model="quantity">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Product Galley</label>
                            <div class="col-md-4" >
