                                ...
                                <ul class="products-cart">
                                    ...
                                    <li class="pr-cart-item">
                                        ...
                                        <div class="product-name">
                                            <a class="link-to-product" href="{{route('product.details', ['slug'=>$item->product->slug])}}">{{$item->name}}</a>
                                        </div>
                                        <div class="price-field produtc-price"><p class="price">${{$item->price}}</p></div>
                                        <div class="quantity">
                                            <h5>{{$item->quantity}}</h5>
                                        </div>
                                        <div class="price-field sub-total"><p class="price">${{$item->price * $item->quamtity}}</p></div>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                    ...
                    <div class="panel-body">
                     <table class="table">
                         <tr>
                             ...
                             <td>{{$order->transaction->mode ? $order->transaction->mode:'' }}</td>
                         </tr>
                         <tr>
                            <th>Status</th>
