        ...
        <div class=" main-content-area">
          ...
          <div class="summary">
                <div class="order-summary">
                    ...
                    <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}}) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger fa-1x"></i></a> </span><b class="index">-${{number_format($discount,2)}}</b></p>
                    <p class="summary-info"><span class="title">Subtotal wih Discount</span><b class="index">${{number_format($subtotalAfterDiscount,2)}}</b></p>
                    ...
                    <a class="link-to-shop" href="{{route('admin.addproduct')}}">Continue Shopping<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                </div>
