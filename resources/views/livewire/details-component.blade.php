					...
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
                            ...
                            <div class="wrap-price">
								<span class="product-price regprice">${{$product->sale_price}}</span>
								<del><span class="product-price">{{$product->regular_price}}</span></del>
							</div>
                            @else
													...
													<div id="comment-20" class="comment_container"> 
														...
														<div class="comment-text">
															...
															<p class="meta"> 
																...
																<time class="woocommerce-review__published-date" datetime="2008-02-14 20:00" >{{Carbon\Carbon::parse($orderItem->review->created_at)->format('d F Y g:1 A')}}</time>
															</p>
